...
<template>
  ...
  <section class="grid grid-cols-3 gap-4 justify-center">
    <article class="hover:font-mono">
      <header class="bg-green-700 rounded-md">
        <h2 class="text-xl text-green-950 font-semibold p-4">
          Python in Daily Work
        </h2>
      </header>
      <section class="bg-amber-100 px-2 py-1 min-h-80">
        <p class="indent-4">
      ...
      <footer class="bg-amber-500 p-2 text-center">
        <address>
          By Marky
        </address>
